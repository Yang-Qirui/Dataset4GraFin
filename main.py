...
if __name__ == "__main__":
    ...
    fig = visualize_heatmap(heat_positions, heat_values, floor_plan_filename, width_meter, height_meter, colorbar_title='mu tesla', title='Magnetic Strength', show=False)
    ...
    print("heat pos", len(heat_positions)) # Hint: only consider position with heat value > 0
    print(heat_positions)
